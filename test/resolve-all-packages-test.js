...
test('resolveAllPackages() packages w nested dependencies that are all unique', function * (t) {
  ...
  const expected = {
    foo: {name: 'foo', version: '1.0.0', dependencies: {bar: '^2.0.0'}},
    'foo@1.0.0': {name: 'foo', version: '1.0.0', dependencies: {bar: '^2.0.0'}},
    'bar@^2.0.0': {name: 'bar', version: '2.1.2', dependencies: {bas: '~1.0.0'}},
    'bar@2.1.2': {name: 'bar', version: '2.1.2', dependencies: {bas: '~1.0.0'}},
    'bas@~1.0.0': {name: 'bas', version: '1.0.5', dependencies: {}},
    'bas@1.0.5': {name: 'bas', version: '1.0.5', dependencies: {}}
  };
